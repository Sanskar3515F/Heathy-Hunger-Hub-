...
export const menuItems: MenuItem[] = [
  ...
  { id: "peanut-butter-oats", name: "Peanut Butter Banana Oats", description: "Oats, peanut butter, milk, banana, honey, watermelon seeds, til", price: "₹ 70", category: "oats", image: "/images/menu/oats.jpg", veg: true, macros: { protein: "22g", fat: "11g", carbs: "74g", calories: "540 kcal" } },
  { id: "dry-fruits-oats", name: "Dry Fruits Oats Bowl", description: "Oats, milk, almond, cashew, raisins, honey, pumpkin seed, alsi, banana", price: "₹ 80", category: "oats", image: "/images/menu/Dry Fruits Oats Bowl.jpg", veg: true, macros: { protein: "23g", fat: "14g", carbs: "87g", calories: "670 kcal" } },
  { id: "chocolate-oats", name: "Chocolate Oats Bowl", description: "Oats, milk, coco powder, banana, dark chocolate, honey, pump seeds, til, alsi", price: "₹ 70", category: "oats", image: "/images/menu/Chocolate Oats Bowl.jpg", veg: true, macros: { protein: "19g", fat: "12g", carbs: "76g", calories: "520 kcal" } },
  { id: "whey-protein-oats", name: "Whey Protein Oats Bowl", description: "Whey protein, oats, milk, peanut butter, sunflower seeds, til, banana, honey", price: "₹ 155", category: "oats", image: "/images/menu/Whey Protein Oats Bowl.jpg", veg: true, macros: { protein: "44g", fat: "12g", carbs: "77g", calories: "720 kcal" } },

  { id: "protein-powder-bread", name: "Protein Powder Bread", description: "Brown bread, peanut butter, honey, banana, pumpkin seed, sunflower seeds, alsi, til", price: "₹ 70", category: "breads", image: "/images/menu/Brown-Bread.jpg", veg: true, macros: { protein: "20g", fat: "18g", carbs: "75g", calories: "800 kcal" } },
  { id: "dark-chocolate-bread", name: "Dark Chocolate Bread", description: "Brown bread, dark chocolate, honey, banana, almond, cashews, raisins", price: "₹ 80", category: "breads", image: "/images/menu/brownbreadnew.JPG", veg: true, macros: { protein: "19g", fat: "12g", carbs: "87g", calories: "760 kcal" } },

  { id: "plain-sprouts", name: "Plain Sprouts", description: "3 types sprouts, vegetables, peanut", price: "₹ 40", category: "sprouts", image: "/images/menu/spourt.jpg", veg: true, bestseller: true, macros: { protein: "16g", fat: "16g", carbs: "62g", calories: "370 kcal" } },
  { id: "special-sprouts", name: "Special Sprouts", description: "3 types sprouts, vegetables, mix seeds, peanut, raisins", price: "₹ 60", category: "sprouts", image: "/images/menu/specialsprots.jpg", veg: true, macros: { protein: "19g", fat: "22g", carbs: "85g", calories: "620 kcal" } },
  { id: "sprouts-paneer", name: "Sprouts With Panner", description: "3 types sprouts, panner, vegetables, mix seeds, peanut, raisins", price: "₹ 90", category: "sprouts", image: "/images/menu/sprotwithpanner.jpg", veg: true, macros: { protein: "26g", fat: "16g", carbs: "62g", calories: "480 kcal" } },

  { id: "whey-shake", name: "Whey Protein Shake", description: "Whey protein, water", price: "₹ 111", category: "shakes", image: "/images/menu/whey-protein.png", veg: true, macros: { protein: "24g" } },
  { id: "seeds-whey-shake", name: "Seeds Whey Protein Shake", description: "Whey protein, peanut butter, milk, banana, honey, pumpkin seeds, sunflower seeds", price: "₹ 149", category: "shakes", image: "/images/menu/seedproteinshake.jpg", veg: true, macros: { protein: "44g", fat: "11g", carbs: "70g", calories: "764 kcal" } },
  { id: "dry-fruits-whey-shake", name: "Dry Fruits Whey Protein Shake", description: "Whey protein, milk, banana, almond, cashew, raisins", price: "₹ 159", category: "shakes", image: "/images/menu/Dry Fruits Whey Protein Shake.jpg", veg: true, macros: { protein: "42g", fat: "8g", carbs: "86g", calories: "711 kcal" } },
  { id: "milk-shake-smoothie", name: "Milk Shake Smoothie", description: "Milk, peanut butter, banana, honey, almond, cashew, raisins, pumpkin seeds, sunflower seeds", price: "₹ 99", category: "shakes", image: "/images/menu/smoothie.png", veg: true, macros: { protein: "28g", fat: "12g", carbs: "87g", calories: "815 kcal" } },

  { id: "chia-dry-fruits", name: "Chia Seeds With Dry Fruits", description: "Chia seeds, milk, banana, honey, almond, cashew, raisins, til", price: "₹ 70", category: "chia_seeds", image: "/images/menu/cheaseed.jpg", veg: true, macros: { protein: "19g", fat: "23g", carbs: "91g", calories: "750 kcal" } },
  { id: "chia-dark-chocolate", name: "Chia Seeds With Dark Chocolate", description: "Chia seeds, milk, banana, dark chocolate, coco powder, sunflower seeds, pumpkin seeds, magaj", price: "₹ 75", category: "chia_seeds", image: "/images/menu/Chia Seeds With Dark Chocolate.jpg", veg: true, macros: { protein: "21g", fat: "30g", carbs: "95g", calories: "959 kcal" } },
];
